    ...
    <div class = "col-md-12">
        <div class = "container">
            <div class = "jumbotron"><!--jumbotron-->
                ...
                <br>
                <br>
                <h1>FOREVERMORE EVENTS</h1><!--jumbotron heading-->
                <br>
                <br>
                <br>
                <br>
                <br>
                <p><!--jumbotron content-->
                Looking for a planner for your bachelorette party, birthday parties, weddings, conference, business
                meeting, anniversaries or private dining event, our dedicated Forevermore team can create a package that will meet
                your every need. Why late, EXPLORE!
                </p>
